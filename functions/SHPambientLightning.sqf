...
_interval - Maximum duration in which lightning strikes. Default is 60 seconds.
	...
	_nul = [_center, _radius, _interval] execVM "functions\SHPambientLightning.sqf";
...
Spawn lightning with defaults of player center, 800m radius, and 60s interval:
	...
	_nul = [] execVM "functions\SHPambientLightning.sqf";

Spawn lightning with transportHelicopter as center, 300m radius, and 20s interval:

	_nul = [transportHelicopter, 300, 20] execVM "functions\SHPambientLightning.sqf";

Spawn lightning with marker as center, 500m radius, and default interval:

	_nul = ["lightningCenter", 500] execVM "functions\SHPambientLightning.sqf";

Spawn lightning with position array as center, default radius, and default interval:

	_nul = [[2482.0117,32.202206,22100.438]] execVM "functions\SHPambientLightning.sqf";
...
_interval = [_this, 2, 6, [0]] call BIS_fnc_param;
...
while {SHPLightningRun} do {
	...
	_bolt setdamage 0;																						// SetDamage required for proper lightning effect. Also does damage to strike location.
